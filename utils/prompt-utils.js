const GENERATE_RANDOM_PEOPLE = 'Come up with a name and description of two interesting people that could talk to each other. Please respond in json format of the the following structure: [{ "name": "person1-name", "description": "person1-description" }, { "name": "person2-name", "description": "person2-description" }]';
const GENERATE_SCENE = 'You are an assistant specialized in generating descriptions of realistic scenes that are only 3 sentences long.';

function coordinateConversation(
...
function generatePersonDescription(chatbotName) {
